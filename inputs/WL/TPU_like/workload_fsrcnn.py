workload = {
    ...
    0: {'equation': 'O[b][k][oy][ox]+=W[k][c][fy][fx]*I[b][c][ix][iy]',
        ...
        'constant_operands': ['W'],
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 32)},  # Must match with the dimensions of core 1
    ...
    1: {'equation': 'O[b][k][oy][ox]+=W[k][c]*I[b][c][ox][oy]',
        ...
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 12), 'D2': ('C', 32)},  # Must match with the dimensions of core 1
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
        }
    ,
    ...
    6: {'equation': 'O[b][k][oy][ox]+=W[k][c]*I[b][c][ox][oy]',
        ...
        'operand_source_dimension_mapping': {'I': {'OX': 'OX', 'OY': 'OY', 'C': 'K'}},
        'core_allocation': 1,
        'spatial_mapping': {'D1': ('K', 32), 'D2': ('C', 12)},  # Must match with the dimensions of core 1
        'memory_operand_links': {'O': 'O', 'W': 'I2', 'I': 'I1'}
        }
    ,
